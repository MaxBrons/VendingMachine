...
public class Main {
    ...
    public static ArrayList<String> jaNee = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        WarmEten.add("1.Pannenkoeken €2.50");//0
        WarmEten.add("2.Hamburger €2.50");//1
        WarmEten.add("3.Patat €1.50");//2

        KoudEten.add("1.Salade €2.00");//0
        KoudEten.add("2.Sandwich €2.50");//1
        KoudEten.add("3.Seizoenen bord €3.00");//2

        jaNee.add("Ja");//0
        jaNee.add("Nee");//1

        //array voor de frisdranken//
        Drank.add("1.Coca Cola €1.50");//0
        Drank.add("2.Fanta €1.50");//1
        Drank.add("3.Sprite €1.00");//2
        Drank.add("4.7-Up €1.00");//3
        Drank.add("5.Mountain Due €1.25");//4

        //array's voor warme draken
        WarmeDrank.add("1.Warme chocolade melk(small) €1.00");//0
        WarmeDrank.add("2.Warme chocolade melk(medium) €1.50");//1
        WarmeDrank.add("3.Warme chocolade melk(large) €2.00");//2
        WarmeDrank.add("4.Thee kaneel €1.50");//3
        WarmeDrank.add("5.Koffie €1.25");//4


        //array's voor koude dranken
        KoudeDrank.add("1.Chocomel €1.50");//0
        KoudeDrank.add("2.Water");//1
        KoudeDrank.add("3.Bananen Smoothy €2.25");//2
